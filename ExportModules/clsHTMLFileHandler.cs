...
namespace Cyclops.ExportModules
{
    ...
    /// </summary>
    public static class clsHTMLFileHandler
    {
        ...
        public static string GetNavBar(List<clsHtmlLinkNode> NavBar, string NavBarAlignment)
        {
            ...
            foreach (clsHtmlLinkNode n in NavBar)
            {
                if (!n.IsInternalLink)
                {
            ...
            s_Return += s_Tab + s_Tab + s_Tab + "</UL>" + s_LineDelimiter;
            //s_Return += s_Tab + s_Tab + "</NAV>" + s_LineDelimiter;
            //s_Return += string.Format("{0}{0}</{2}>{1}{0}{0}"
            //    , s_Tab
            //    , s_LineDelimiter
            //    , NavBarAlignment
            //    );
        ...
        public static string GetNavTable(List<clsHtmlLinkNode> NavTable)
        {
            string s_Return = "", s_Tab = "\t", s_LineDelimiter = "\n";
            ...
            foreach (clsHtmlLinkNode n in NavTable)
            {
                if (!n.IsInternalLink)
                {
        ...
        private static DataTable GetDatasetInfo(string DatabaseFileName)
        {
            ...
            if (clsSQLiteHandler.TableExists("t_factors", DatabaseFileName))
            {
                return clsSQLiteHandler.GetDataTable(
                    s_Command, DatabaseFileName);
            }
            else
                return null;
        }
